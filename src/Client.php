...
class Client implements ClientInterface
{
     ...
     *
     * @see \ArmoniaGuzzleHttp\RequestOptions for a list of available request options.
     */
     ...
     *                       request and to the transfer. See \ArmoniaGuzzleHttp\RequestOptions.
     *
     * @return Promise\PromiseInterface
     */
     ...
     * @param array               $options Request options to apply. See \ArmoniaGuzzleHttp\RequestOptions.
     *
     * @return Promise\PromiseInterface
     */
     ...
     *
     * @param array $options See \ArmoniaGuzzleHttp\RequestOptions.
     *
     * @return Promise\PromiseInterface
     */
    ...
    private function applyOptions(RequestInterface $request, array &$options)
    {
        ...
        if (isset($options['json'])) {
            $options['body'] = \ArmoniaGuzzleHttp\json_encode($options['json']);
            unset($options['json']);
            // Ensure that we don't have the header in different case and set the new value.
            $options['_conditional'] = Psr7\_caseless_remove(['Content-Type'], $options['_conditional']);
